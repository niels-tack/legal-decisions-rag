...
- What is the Council of State's own paragraph-numbering convention (its published case law is unlikely to share the Constitutional Court's `A.`/`B.`-lettered scheme) - needs inspecting real rulings before a second `SourceConfig` entry and marker pattern can be registered.
